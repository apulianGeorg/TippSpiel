...
public class InternalConstants {
    public final static String TippFile="TippFile.txt";
    public final static String Tipper="Tipper";
    public final static String TipperId="TipperId";
    public final static String TipperName="TipperName";
